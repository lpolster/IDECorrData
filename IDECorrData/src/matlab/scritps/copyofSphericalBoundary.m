...
SpaceMaxPeriodicField = 20;                    % maximum space in mm, should take input from the parent script!!!!
SpaceMinPeriodicField = -20;         % minimum space in mm
